...
// Corpo do editor de banco/pessoa/imobilizado, compartilhado entre o modal
// mobile (LaunchesEditorModal) e o modal desktop (LaunchesEditorAppModal).
export default function LaunchesEditorFields({
	editorMode,
	section,
	editingItem,
	editorValue,
